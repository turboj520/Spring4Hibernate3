...
//			HessianRemote, Hessian2Constants, HessianRemoteResolver, Deserializer
	...
	implements Hessian2Constants
{
	...
	private static final Logger log = Logger.getLogger(com/autohome/com/caucho/hessian/io/Hessian2Input.getName());
...
label0:
		...
		throws IOException
	{
		...
		case 111: // 'o'
		{
			...
			if (_classDefs == null)
			{
				throw error((new StringBuilder()).append("No classes defined at reference '{0}'").append(tag).toString());
			} else
			{
				ObjectDefinition def = (ObjectDefinition)_classDefs.get(ref);
		...
		throws IOException
	{
		...
		if (obj != null)
			return error((new StringBuilder()).append("expected ").append(expect).append(" at 0x").append(Integer.toHexString(ch & 0xff)).append(" ").append(obj.getClass().getName()).append(" (").append(obj).append(")").toString());
