...
// Source File Name:   SubscribedPageHandler.java
	...
	implements PageHandler
{
	...
	public Page handle(URL url)
	{
		...
		return new Page((new StringBuilder()).append("<a href=\"registries.html\">Registries</a>").append(select.toString()).append(" &gt; <a href=\"registered.html?registry=").append(registryAddress).append("\">Registered</a> | Subscribed").toString(), (new StringBuilder()).append("Subscribed (").append(rows.size()).append(")").toString(), new String[] {
			"Consumer URL:"
		}, rows);
	}
}
