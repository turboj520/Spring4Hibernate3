...
var App = function() {
	...
	var handleDesktopTabletContents = function() {
		...
		// for tablet mode
		// For metornic 1280px or less set as tablet mode to display the content
		// properly
		...
		// for desktop mode
		// For metornic higher 1280px set as desktop mode to display the content
		// properly
	...
	var handleSidebarMenu = function() {
		jQuery('.page-sidebar').on('click', 'li > a', function(e) {
			if ($(this).next().hasClass('sub-menu') == false) {
				if ($('.btn-navbar').hasClass('collapsed') == false) {
					...
					// 选中当前节点的根节点为选中 红色 <span class='selected'></span>
					$(this).closest('.root').addClass('active');
					// 当前选中的叶子节点添加选中样式
					$(this).parent().addClass("active");
					// 动态加载菜单
					$("#mainContainer").load(ctx+"/a/mainContainer.do?t=" + Math.random());
				}
				return;
			}
		...
		jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function(e) {
			console.info(".page-sidebar li > a.ajaxify");
			e.preventDefault();
			App.scrollTop();
	...
	var handleFixedSidebarHoverable = function() {
		...
		$('.page-sidebar').off('mouseleave').on(
				'mouseleave',
				function() {
					var body = $('body');

					if ((body.hasClass('page-sidebar-hover-on') === false || body.hasClass('page-sidebar-fixed') === false)
							|| $(this).hasClass('page-sidebar-hovering')) {
						return;
					}
	...
	var handleHorizontalMenu = function() {
		$('.header').on('click', '.nav li > a', function(e){
			console.log("click horizontal menu | " + $(this).attr('href'));
