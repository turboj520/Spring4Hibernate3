package com.keung.spring4hibernate3.common.persistence.dao.hibernate;
...
public abstract class HibernateDaoSupport extends DaoSupport
{
	...
	public final void setHibernateTemplate(HibernateTemplate hibernateTemplate)
	{
		...
		{
			//			this.hibernateTemplate.setCacheQueries(BaseDao.isUseQueryCache);
		}
	}
	...
	protected final Session getSession(boolean allowCreate) throws DataAccessResourceFailureException, IllegalStateException
	{
		...
		if (sf != null)
		{
			Session se = (!allowCreate ? SessionFactoryUtils.getSession(sf, false) : SessionFactoryUtils.getSession(sf, this.hibernateTemplate.getEntityInterceptor(), this.hibernateTemplate.getJdbcExceptionTranslator()));
			if (se != null)
			{
				//				ThreadSessionManager.put(sf, se);
			}
			return se;
		}
		return null;
	...
	protected final void releaseSession(Session session)
	{
		if (session != null)
		{
			...
			// ThreadSessionManager.remove(getSessionFactory(), session);
		}
	}
