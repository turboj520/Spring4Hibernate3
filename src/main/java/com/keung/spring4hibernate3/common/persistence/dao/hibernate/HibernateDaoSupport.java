...
public abstract class HibernateDaoSupport extends DaoSupport {
    ...
    protected final Session getSession(boolean allowCreate) throws DataAccessResourceFailureException,
        ...
        if (sf != null) {
            Session se = (!allowCreate ? SessionFactoryUtils.getSession(sf, false) : SessionFactoryUtils.getSession
					(sf, this.hibernateTemplate.getEntityInterceptor(), this.hibernateTemplate
