...
@Service
@Transactional
public class MtDisIdService extends BaseService<MtDisId>
{
	 ...
	 */
	@Override
	@Resource(name = "mtDisIdDao")
	public void setBaseDao(BaseDao<MtDisId> baseDao)
	{
		this.baseDao = baseDao;
	}
	@Override
	@Transactional(propagation = Propagation.NEVER)
	public void insert(MtDisId entity) 
	{
	...
	@Override
	@Transactional(propagation = Propagation.NEVER)
	public void update(MtDisId mtDisId) {
		getBaseDao().update(mtDisId);
	}
}
